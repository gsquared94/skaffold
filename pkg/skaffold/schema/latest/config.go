...
type GitInfo struct {
	// Repo is the git repository the package was cloned from.  e.g. `https://github.com/GoogleContainerTools/skaffold.git`
	Repo string `yaml:"repo" yamltags:"required"`

	// Path is the relative path from the repo root to the skaffold configuration file. eg. `getting-started/skaffold.yaml` or simply `getting-started`
	Path string `yaml:"path,omitempty"`

	// Ref is the git ref the package was cloned from. eg. `master` or `main`
