...
func fakeBuilder(_ context.Context, out io.Writer, a *latest.Artifact, tag string, req []Artifact) (string, error) {
	fmt.Fprintln(out, "building", a.ImageName, "with tag", tag)
	return "digest", nil
}

func fakeFailingBuilder(_ context.Context, out io.Writer, a *latest.Artifact, tag string, req []Artifact) (string, error) {
