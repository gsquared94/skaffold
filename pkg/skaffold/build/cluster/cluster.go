...
func (b *Builder) Build(ctx context.Context, out io.Writer, tags tag.ImageTags, artifacts []*latest.Artifact, existing []build.Artifact) ([]build.Artifact, error) {
	...
	return build.InOrder(ctx, out, tags, artifacts, builder, b.ClusterDetails.Concurrency, existing)
}
...
func (b *Builder) buildArtifact(ctx context.Context, out io.Writer, artifact *latest.Artifact, tag string, _ build.ArtifactResolver) (string, error) {
	// TODO: [#4922] Implement required artifact resolution from the `ArtifactResolver` as a Build Arg
