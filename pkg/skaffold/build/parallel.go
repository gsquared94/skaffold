...
type ArtifactBuilder func(ctx context.Context, out io.Writer, artifact *latest.Artifact, tag string, deps []ArtifactDependency) (string, error)
...
func getBuildResult(ctx context.Context, cw io.Writer, tags tag.ImageTags, artifact *latest.Artifact, build ArtifactBuilder) (string, error) {
	...
	return build(ctx, cw, artifact, tag, nil)
}
