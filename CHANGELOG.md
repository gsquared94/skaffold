...
Fixes:
* Re-use key created for a release. [#5996](https://github.com/GoogleContainerTools/skaffold/pull/5996)* fix command example [#6002](https://github.com/GoogleContainerTools/skaffold/pull/6002)
